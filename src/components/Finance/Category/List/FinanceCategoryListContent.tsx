...
export const FinanceCategoryListContent = () => {
  ...
  return (
    <motion.ul className="grid h-full grid-cols-2 content-start gap-4 overflow-auto overflow-x-hidden pr-6 pb-4 pl-2 sm:grid-cols-4 md:grid-cols-5 xl:grid-cols-7 2xl:grid-cols-8">
