...
export const FinanceTransactionListContent = () => {
  ...
  return (
    <motion.ul className="grid h-full grid-cols-1 content-start gap-4 overflow-auto overflow-x-hidden pr-6 pb-4 pl-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
